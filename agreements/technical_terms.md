...
2. ### Definitions
    ...
    Sprint
    :   A Sprint is dxw digital's basic unit of work. A Sprint consists of
        the services of a dxw digital team for a set period of time, and
    ...
    Started
    :   A Story has been Started when dxw digital has started its implementation.
...
4. ### Sprints
    ...
    3.  At any time, you may request that the length of the Sprint or
        ...
        we dxw digital will accommodate such requests.
    ...
    8.  During each Sprint, dxw digital will implement Stories, starting with
        the most important Story in the Backlog.
    9.  At the beginning of each Sprint, dxw digital will give an indication of
        the number of Stories dxw digital expects to be able to complete during
    ...
    11. After a Story has been Started:
        ...
        1.  You may not change the Story without dxw digital's prior agreement;
        2.  You may instruct us to cease work on the Story;
        3.  We will make reasonable efforts to complete the Story
            within the Sprint.

    12. After dxw digital believe a Story has been Finished:

        1.  dxw digital will make it available to you for your testing and
            review;
...
8. ### Subcontracting
    ...
    1.  At dxw digital's sole discretion, freelancers or contractors may be used
        in place of dxw digital employees in order to complete Sprints or
        Surrounding Activities.
...
13. ### Payments
    ...
    1.  dxw digital will issue invoices for Sprints on the day after the last
        day of the Sprint.
