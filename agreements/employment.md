...
Following lawyer review:
* More exhaustive list of things which can cause termination without notice
* Added entitlement to holiday pay (or deduction) on termination
* Warranties (promises that you are allowed to work here)
* Hours of work amended to comply with working time regulations
* Method of calculation added on termination
* Sickness is now "incapacity", and this section is more detailed
* General duties now more comprehensive and explicit
* Confidentiality is defined (albeit not very well)
* Some provisions added around conflicts of interest
* Parental leave and retirement age sections removed, as they are not required
* Lots of boilerplate additions: headings, jurisdiction, third-party rights, changes, etc
...
4. ### Duties
    1. During your employment with us, unless prevented by incapacity (see clause 12.1), you must:  
...
6. ### Hours of work
    1. Unless you work part-time, your normal working day is seven hours long, making a 35 hour working week. During busy periods, you may be required to work longer hours, up to a maximum of 48 hours a week, on average, over a rolling six week period.
...
10. ### Gross misconduct
    1. dxw may dismiss you with immediate effect, without notice and with no obligation to make further payments (other than those accrued at the date of termination) if you:
        ...
        5. are, in the opinion of a qualified medical practitioner who has given that opinion to dxw, physically or mentally incapable of performing your duties and may remain so for more than three months;
        6. cease to be eligible to work in the United Kingdom;
        7. are guilty of any fraud or dishonesty or act in any manner which in dxw's opinion may bring you or dxw into disrepute, or which is materially adverse dxw's interests.
    2. The following is an indicative, non-exhaustive list of things that might constitute gross misconduct:
        1. fighting or assaulting another person or causing another person to fear violence;
        2. deliberately damaging property;
        3. deliberately or recklessly disclosing confidential information or personal data to a third party;
        4. persistent offensive, intimidating or humiliating behaviour which attempts to undermine an individual or group of employees;
        5. a serious failure to abide by dxw's values, policies or general duties.
...
13. ### Incapacity
    1. Incapacity means any sickness, injury or other medical condition which prevents the Employee from carrying out your duties.
    1. If you are absent due to incapacity, you must inform dxw by 10:00 on the day of your absence.
    2. After the conclusion of your probationary period, dxw will pay your normal salary for up to ten days of incapacity per year.
    3. Pension contributions will continue as normal while you are paid at your normal salary. If your pay during any period of incapacity absence, or if you are paid Statutory Sick Pay (SSP) only, the level of contributions made may change, depending on the Aviva pension scheme rules in force at the time.
    4. You agree to consent to medical examination (at the Company's expense) by a doctor nominated by dxw, if we so require. You agree that any report produced in connection with any such examination may be disclosed to dxw and that we may discuss the contents of the report with the relevant doctor.
    5. Further details of dxw's incapacity absence arrangements are published in the Playbook.
...
17. ### Confidentiality
    1. Confidential information is any information that the company considers confidential. For more information on what the company considers confidential, refer to the playbook.
    ...
    4. The restrictions in clauses 15.2 and 15.3 will not apply if:
        ...
        3. the disclosure is protected by s43A of the Employment Act 1996.
    4. On ending your employment with us you must return to us any physical documents given to you, or generated by you, during the course of your employment.
...
19. ### Gratuituies
    ...
    4. You must not offer any gifts or hospitality to a customer, supplier or any other such person with an interest in or connection to dxw if it might reasonably be seen to compromise their judgement or integrity.
...
21. ### Playbook
    1. Further rules, practices and policies concerning your employment with us, and which you agree to abide by, are contained in the Playbook.
    2. dxw would like to draw your attention to the _Working arrangements_ section of the playbook, which contains policies relevant to all employees.
    2. The Playbook will be varied by us from time to time. We will give you notice of any such changes.
...
<small>Version: 26th May 2017</small>
